...
#     url = rf"{public_holidays_url}/{year}/BR"
...
#     public_holidays_df = read_json(response.text)
#     public_holidays_df.drop(columns=['counties','types'], inplace=True)
...
print(get_public_holidays(PUBLIC_HOLIDAYS_URL, '2017').columns)